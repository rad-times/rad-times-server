...
public class ImageManagerService {
    ...
    @Autowired
    ImageManagerService(AmazonClientUtil amazonClient) {
        this.amazonClient = amazonClient;
    }

    public SavedImageDTO uploadFile(ImageFileDTO fileDTO) {
        SavedImageDTO savedFile = new SavedImageDTO();
    ...
    private String generateFileName(ImageFileDTO fileDTO) {
